...
const HeroSection = () => {
  return (
    <div className=' md:flex items-center justify-center w-full h-[80vh] gap-10  '>
        ...
        <Typography variant='h1' className={" mt-10"}>Professional <span className='text-primary'>Resume Writer</span> to elevate your career success & effortlessly.</Typography>
